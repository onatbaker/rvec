...
namespace rvec {
    ...
    private:
        ...
        static constexpr size_type chunk_index(size_type i) { return i / ChunkSize; }
        static constexpr size_type within_chunk_index(size_type i) { return i % ChunkSize; }
    ...
    public:
        ...
        T& at(size_type i) {
            if (i >= total_size) throw std::out_of_range("rvec::at() index out of range");
            return (*this)[i];
        }
        ...
        T& front() {
            if (empty()) throw std::out_of_range("rvec::front() called on empty vector");
            return (*this)[0];
        }
        ...
        T& back() {
            if (empty()) throw std::out_of_range("rvec::back() called on empty vector");
        ...
        void insert(size_type pos, const T& value) {
            if (pos > total_size) throw std::out_of_range("insert position out of bounds");
        ...
        void erase(size_type pos) {
            if (pos >= total_size) throw std::out_of_range("erase position out of bounds");
